...
namespace IFix.Core
{
    ...
    unsafe public partial class VirtualMachine
    {
            ...
            int refCount = 0, Value** topWriteBack = null)
        {
            if (UseExecuter)
            {
                Value* r = ExecuteCpp(pc, argumentBase, managedStack,
                                    evaluationStackBase, argsCount, unmanagedCodes,
            ...
            VMExecuteContext context;
            context.m_pc = &pc;
            context.m_argumentBase = &argumentBase;
            context.managedStack = managedStack;
            context.m_evaluationStackBase = &evaluationStackBase;
            context.m_argsCount = &argsCount;
            context.m_methodIndex = &methodIndex;
            context.m_refCount = &refCount;
            context.m_topWriteBack = &topWriteBack;
            context.m_evaluationStackPointer = &evaluationStackPointer;
            context.m_localBase = &localBase;
            ...
            while (true) //TODO: 常用指令应该放前面
            {
                ...
                catch(Exception e)
                {
                    ...
                    else
                    {
                        ...
                        throwExcepton = null;
                        Console.WriteLine($"Stack : {e.ToString()}");
                        throw e;
                    }
                }
            }
